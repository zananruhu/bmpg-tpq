...
<div class="container mt-4">
    <div class="row justify-content-center mb-5">
        <div class="col-md-8">
         ...
         <h2 class="text-dark text-center mb-2">{{ $tpq->name }}</h2>
            <small><p>Alamat : <a href="" style="text-decoration: none;"> {{ $tpq->alamat }}</a>| Pengurus Kecamatan  {{ $tpq->kecamatan->name }} </p></small> 
                <img class="img-fluid" src="https://source.unsplash.com/1200x400?hd" alt="" >
                <article class="my-3 fs-4">
            {!! $tpq->profil_tpq !!}
           </article>
        
            <a href="/tpqs" class="d-block mt-5">Kembali</a>
        </div>
    </div>
